# Generated by Django 3.2.7 on 2023-05-05 18:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre_rp', models.CharField(blank=True, max_length=255)),
                ('numero_personas', models.PositiveIntegerField()),
                ('comentarios', models.TextField(blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='ReservacionHistorico',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hora_inicio', models.DateTimeField()),
                ('hora_finalizacion', models.DateTimeField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='nm', max_length=200)),
